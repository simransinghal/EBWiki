...
feature 'User follows a case from show' do
...
# feature "User follows an case from followers page" do
# 	let(:case) { FactoryBot.create(:case) }
# 	scenario "User arrives at the case show page and clicks to follow" do
#
# 		user = FactoryBot.create(:user)
# 		login_as(user, scope: :user)
# 		visit cases_followers_path(case)
# 		click_link 'Track this case'
# 		expect(case.followers.count).to eq(1)
# 	end
# end
